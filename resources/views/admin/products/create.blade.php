...
<div class="max-w-3xl mx-auto px-3 py-4">
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-xl shadow-lg space-y-5">
        @csrf
        ...
        <button type="submit" class="w-full bg-blue-600 text-white px-6 py-2 rounded-lg shadow hover:bg-blue-700 transition font-semibold text-lg">Save Product</button>
    </form>
</div>
